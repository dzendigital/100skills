...
class CreateBlogTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create("catalog_blog", function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('is_index')->nullable(); # заглавная статья
            $table->integer('is_visible')->nullable(); # видимость
            $table->integer('sort')->nullable(); # сортировка
        ...
        Schema::create('gallery_blog', function (Blueprint $table) {
            ...
            $table->foreign('item_id')->references('id')->on('catalog_blog')->onDelete('cascade');
        
            $table->primary(['gallery_id', 'item_id']);

        }); 
        # таблица содержит отношения между directions и transport в случае когда отношения belongsToMany 
        Schema::create('video_blog', function (Blueprint $table) {
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('catalog_blog');
