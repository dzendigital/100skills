...
<form data-component="search-short-form"
      class="<?=$class ?> uk-search uk-search-default m-none" 
    ...
    <input class="uk-search-input" 
           type="search"
           name="query"
           value="<?= (isset($query['raw']) ? $query['raw'] : '') ?>"   
           placeholder="Какой курс профессию или навык ищем?">
    <button type="submit" class="btn btn-red form-btn">Поехали</button>
</form>
<p class="tags m-none">Популярное:
    <a href="/catalog/?query=UX/UI-дизайн">#UX/UI-дизайн</a>
    <a href="/catalog/?query=Геймдизайн">#Геймдизайн</a>
    <a href="/catalog/?query=SMM">#SMM</a>
    <a href="/catalog/?query=Маркетинг">#Маркетинг</a>
</p>