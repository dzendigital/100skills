        ...
        <div class="container">
            ...
            <section class="section-last">
                <h1 class="mt-5">
                    ...
                    <form action="/account/actions/<?=$form['id'] ?>" 
                          data-component="account-course-form"
                          onsubmit="event.preventDefault(); submitActionUpdateForm();" 
                          > 
                          @csrf
                        ...
                        <div class="row">
                            <div class="col-md-7 row">
                                ...
                                <div class="col-md-12 mb-4">
                                    ...
                                    <textarea class="uk-textarea" name="body_short" rows="8" placeholder="Введите краткое описание"><?=(isset($form["body_short"]) && !is_null($form["body_short"]) && !empty($form["body_short"]) ? $form["body_short"] : "" ) ?></textarea>
                                </div>
                                <div class="col-md-12 mb-4">
                                    <label>Полное описание</label>
                                    <textarea class="uk-textarea" rows="8" name="body_long" placeholder="Расскажите больше об акции. Для кого она, кому подходит и так далее"><?=(isset($form["body_long"]) && !is_null($form["body_long"]) && !empty($form["body_long"]) ? $form["body_long"] : "" ) ?></textarea>
                                </div>
                                    <div class="col-md-4">
