...
use App\Http\Requests\Panel\Course\CategoryRequest;
...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        $response = array();
        $response['page'] = array();
        $response['items'] = json_encode(array());
        $response['transport'] = json_encode(array());
        $response['city'] = json_encode(array());
