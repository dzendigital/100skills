    ...
    <section class="section-hidden" data-component="section-found">
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-md-4 uk-text-right@m">
                    <a href="/catalog" class="btn btn-red">Вернуться в каталог</a>
                </div>
            </div>
        </div>
        <div class="course-slides mt-5">
            <div class="uk-position-relative uk-visible-toggle pb-4 related-course-mobile" tabindex="-1" uk-slider>

                <ul class="uk-slider-items uk-child-width-1-2 uk-child-width-1-5@m uk-grid">
                    <?php foreach ( (isset($items["similar"]) ? $items["similar"] : array()) as $value): ?>
                        <li>
