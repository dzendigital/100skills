...
namespace App\Http\Controllers\Panel\School;

use App\Http\Controllers\Controller;
use Illuminate\Http\Request;

use App\Http\Requests\Panel\School\ItemRequest;
use App\Models\School\Item;
...
class ItemController extends Controller
{
    ...
    {   
        ...
        $item->is_visible = 1;
        // dd(__METHOD__, $validatedData, $item);
        # сохранение объекта
        $result = $item->save();
