            ...
            <div class="uk-overflow-auto section-last mt-5">
                ...
                <table class="uk-table uk-table-hover uk-table-middle uk-table-striped uk-table-responsive">
                    ...
                    <tbody data-component="course-tbody">
                        ...
                        <?php if ( !isset($items) ): ?>
                            <tr>
                                <td colspan="6">Курсы не добавлены. <a style="cursor: pointer;">Добавить курс.</a></td>
                            </tr> 
                        <?php endif ?>
                        <?php foreach ( (isset($items) ? $items : array()) as $key => $value): ?>
                            <tr>
                                ...
                                <td>
                                    <?php if ( isset($value['gallery']) && !empty($value['gallery']->first()) ): ?>
                                        <img class="uk-preserve-width" src="<?=$value['gallery']->first()->src ?>" width="85" alt="">
                                    <?php else: ?>
                                        <img class="uk-preserve-width" src="/public/files/no-image.png" width="85" alt="">
                                    <?php endif ?>
                                </td>
                                <td>
                                    <h5><a href="/course/<?=$value['id'] ?>"><?=$value['title'] ?></a></h5>
                                </td>
