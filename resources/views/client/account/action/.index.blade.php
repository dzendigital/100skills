   ...
   <main class="main"> 
        <div class="container">
            ...
            <div class="uk-overflow-auto section-last mt-5">
                <a href="#" class="btn btn-red">Удалить <span class="m-none">выбранные</span></a>
                <a href="#" class="btn btn-light" style="padding: 11px 35px;">Отключить <span class="m-none">выбранные</span></a>
                <table class="uk-table uk-table-hover uk-table-middle uk-table-striped uk-table-responsive">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><img class="uk-preserve-width" src="/resources/img/kurs1.png" width="85" alt=""></td>
                            <td>
                                <h5>Фундаментальный JavaScript. С практикой и проектами</h5>
                            </td>
                            ...
                            <td>
                                <a href="#" class="btn border-btn-dark btn-block btn-edit">
                                   <div>
