    ...
    <div class="min-h-screen bg-gray-200">
        ...
        <main id="app" v-cloak data-module='catalog'>
            ...
            <section data-component="item-list" style="padding-top: 0;">          
                <div row>
                    <article>
                        <div>Управление разделом "Блог": список</div>
                    </article>
                            ...
                            <div class="row">
                                <div class="input-field-custom col s12">
                                    <label>
                                        <input 
                                              type="checkbox"  
                                              v-model="form.createTask.inputs.is_index"  
                                              class="filled-in"/>
                                        <span>Чекбокс "Заглавная запись"</span>
                                    </label>
                                </div>
                            </div>
        ...
        methods: {
            ...
            prepareInputObjectToRequest: function(){
                ...
                var item_prepared = {
                    ...
                    is_index: this.form.createTask.inputs.is_index,
            ...
            prepareInputObjectToView: function(item){
                ...
                var item_prepared = {
                    ...
                    is_index: item.is_index != null ? item.is_index : null,
                };
            ...
            updateVisibleCategory: function(event, item)
            {
                ...
                fetch(`/component/blog/category/${item.id}`, {
                    headers: {
                        "Content-Type": "application/json",
                        "Accept": "application/json",
                        "X-Requested-With": "XMLHttpRequest",
            ...
            {
                var vm = this;
                fetch(`/component/blog/${this.form.removeItem.inputs.id}`, {
                    headers: {
                        "Content-Type": "application/json",
                        "Accept": "application/json",
                        "X-Requested-With": "XMLHttpRequest",
            ...
            editCategoryRequest: function(event = null)
            {
                ...
                fetch(`/component/blog/category/${vm.category.edit.id}`, {
                    headers: {
                        "Content-Type": "application/json",
                        "Accept": "application/json",
                        "X-Requested-With": "XMLHttpRequest",
            ...
            changeSortCategory: function(event, item, action = null)
            {
                ...
                fetch(`/component/blog/category/sort`, {
                    headers: {
                        "Content-Type": "application/json",
                        "Accept": "application/json",
                        "X-Requested-With": "XMLHttpRequest",
