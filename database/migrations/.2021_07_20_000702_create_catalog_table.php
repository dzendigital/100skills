...
class CreateCatalogTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('gallery_course', function (Blueprint $table) {
            ...
            $table->foreign('item_id')->references('id')->on('gallery')->onDelete('cascade');
            $table->foreign('course_id')->references('id')->on('catalog_blog')->onDelete('cascade');
        
            $table->primary(['item_id', 'course_id']);
        }); 
