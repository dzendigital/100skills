    ...
    <div class="col-md-4 mt-4">
        <div class="uk-panel p-3 border">
            <div class="mobile-prew">
                ...
                <div>
                    <h5 class="mt-md-4 mb-2"><?=@$value['title'] ?></h5>
                </div>
            </div>
            
            <div class="mt-3 mt-md-0">
                <?php if ( $value["school"]->first() != null ): ?>
                    <span><?=$value["school"]->first()->title ?></span>
                <?php else: ?>
                ...
                <a href="/course/<?=$value['slug'] ?>" class="btn border-btn-dark btn-block mt-4 m-none">Посмотреть курс</a>
            </div>
        </div>
    </div>
<?php endforeach ?>
<?php if ( isset($pagination) ): ?>
    {{ $pagination->appends($form['queryArray'])->links("components.client.catalog.skills-pagination") }}
<?php endif ?>
